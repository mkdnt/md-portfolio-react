...
const projects = [
    {
        ...
        description: `Full Court is a full-stack PERN application created for fantasy basketball players. I created this app as a specific place for writing, reading,and socializing about fantasy basketball, rather than having various apps or sites to do each of those things separately. Registered users display the NBA players on their fantasy basketball team and write posts about their players and their team's progress. They can also view posts from other users on the League Stories page, which allows them to gain insight about how to improve their team. An updated version, with commenting and liking features for user posts, is coming soon.`,
    ...
    },
    {
        ...
        description: `Bookmarks is a frontend application built with jQuery, created for any user on the internet. This app was created to demonstrate jQuery skills, and also to provide a simple, specific area for users to store bookmarks. Users can store a list of links to websites they wish to visit again. Each bookmark is given a description and rating, and can be deleted if the user no longer wants to keep it. Bookmarks can be sorted according to rating.`,
